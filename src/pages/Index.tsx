    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-xs">
        ...
        <div className="text-center mb-6 space-y-4">
          <div className="relative inline-block">
            ...
            <div className="relative bg-gradient-to-br from-primary via-primary-glow to-primary-dark p-[2px] rounded-3xl shadow-[var(--shadow-glow-strong)]">
              <div className="bg-background rounded-3xl p-4 backdrop-blur-xl">
                <div className="relative">
                  <Shield className="w-12 h-12 text-primary" strokeWidth={1.5} />
                  <ShieldCheck className="w-6 h-6 text-primary-glow absolute -top-1 -right-1" strokeWidth={2} />
                  <Sparkles className="w-4 h-4 text-primary-glow absolute -bottom-1 -left-1 animate-pulse" strokeWidth={2} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-1">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground tracking-tight bg-gradient-to-br from-foreground via-foreground to-primary bg-clip-text text-transparent">
              Sahayak
            </h1>
        ...
        <div className="relative group">
          ...
          <div className="relative bg-card/90 border border-border/50 rounded-2xl shadow-2xl backdrop-blur-xl p-6 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-10 bg-input/50 border-border/50 text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-primary focus:border-primary/50 transition-all backdrop-blur-sm"
